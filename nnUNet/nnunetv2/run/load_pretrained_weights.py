import torch
from nnunetv2.utilities.helpers import load_nnunet_checkpoint
...
def load_pretrained_weights(network, fname, verbose=False):
    ...
    if dist.is_initialized():
        saved_model = load_nnunet_checkpoint(fname, map_location=torch.device('cuda', dist.get_rank()))
    else:
        saved_model = load_nnunet_checkpoint(fname)
